...
pub const FLOWFRDONLY: u32 = 0;
pub const FLOWFWRONLY: u32 = 1;
pub const FLOWFRDWR: u32 = 2;
pub const FLOWFACCMODE: u32 = 3;
pub const FLOWFDOWN: u32 = 4;
pub const FLOWFRNOBLOCK: u32 = 512;
pub const FLOWFWNOBLOCK: u32 = 1024;
pub const FLOWFNONBLOCK: u32 = 1536;
pub const FLOWFRNOPART: u32 = 2048;
pub const FLOWFDEFAULT: u32 = 2;
pub const FLOWFINVALID: u32 = 3;
pub const FRCTFRESCNTRL: u32 = 1;
pub const FRCTFRTX: u32 = 2;
pub const FLOWSRCVTIMEO: u32 = 1;
pub const FLOWGRCVTIMEO: u32 = 2;
pub const FLOWSSNDTIMEO: u32 = 3;
pub const FLOWGSNDTIMEO: u32 = 4;
pub const FLOWGQOSSPEC: u32 = 5;
pub const FLOWSFLAGS: u32 = 6;
pub const FLOWGFLAGS: u32 = 7;
pub const FLOWGRXQLEN: u32 = 8;
pub const FLOWGTXQLEN: u32 = 9;
pub const FRCTGFLAGS: u32 = 512;
...
#[test]
fn bindgen_test_layout_qos_spec() {
    assert_eq!(
        ::std::mem::size_of::<qos_spec>(),
        40usize,
        concat!("Size of: ", stringify!(qos_spec))
    );
    assert_eq!(
        ::std::mem::align_of::<qos_spec>(),
        8usize,
        concat!("Alignment of ", stringify!(qos_spec))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<qos_spec>())).delay as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(qos_spec),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<qos_spec>())).bandwidth as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(qos_spec),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<qos_spec>())).availability as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(qos_spec),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<qos_spec>())).loss as *const _ as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(qos_spec),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<qos_spec>())).ber as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(qos_spec),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<qos_spec>())).in_order as *const _ as usize },
        28usize,
        concat!(
            "Offset of field: ",
            stringify!(qos_spec),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<qos_spec>())).max_gap as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(qos_spec),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<qos_spec>())).cypher_s as *const _ as usize },
        36usize,
        concat!(
            "Offset of field: ",
            stringify!(qos_spec),
...
pub type qosspec_t = qos_spec;
extern "C" {
    pub static qos_raw: qosspec_t;
}
extern "C" {
    pub static qos_raw_no_errors: qosspec_t;
}
extern "C" {
    pub static qos_raw_crypt: qosspec_t;
}
extern "C" {
    pub static qos_best_effort: qosspec_t;
}
extern "C" {
    pub static qos_best_effort_crypt: qosspec_t;
}
extern "C" {
    pub static qos_video: qosspec_t;
}
extern "C" {
    pub static qos_video_crypt: qosspec_t;
}
extern "C" {
    pub static qos_voice: qosspec_t;
}
extern "C" {
    pub static qos_voice_crypt: qosspec_t;
}
extern "C" {
    pub static qos_data: qosspec_t;
}
extern "C" {
    pub static qos_data_crypt: qosspec_t;
}
...
extern "C" {
    pub fn flow_alloc(
        ...
        qs: *mut qosspec_t,
        timeo: *const timespec,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn flow_accept(qs: *mut qosspec_t, timeo: *const timespec) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn flow_join(
        bc: *const ::std::os::raw::c_char,
        qs: *mut qosspec_t,
        timeo: *const timespec,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn flow_dealloc(fd: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn flow_write(
        fd: ::std::os::raw::c_int,
...
pub const fqtype_FLOW_PKT: fqtype = 0;
pub const fqtype_FLOW_DOWN: fqtype = 1;
pub const fqtype_FLOW_UP: fqtype = 2;
pub const fqtype_FLOW_ALLOC: fqtype = 3;
pub const fqtype_FLOW_DEALLOC: fqtype = 4;
pub type fqtype = u32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct flow_set {
...
pub type fset_t = flow_set;
pub type fqueue_t = fqueue;
extern "C" {
    pub fn fset_create() -> *mut fset_t;
}
extern "C" {
    pub fn fset_destroy(set: *mut fset_t);
}
extern "C" {
    pub fn fqueue_create() -> *mut fqueue_t;
}
extern "C" {
    pub fn fqueue_destroy(fq: *mut fqueue);
}
extern "C" {
    pub fn fset_zero(set: *mut fset_t);
}
extern "C" {
    pub fn fset_add(set: *mut fset_t, fd: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn fset_has(set: *const fset_t, fd: ::std::os::raw::c_int) -> bool;
}
extern "C" {
    pub fn fset_del(set: *mut fset_t, fd: ::std::os::raw::c_int);
}
extern "C" {
    pub fn fqueue_next(fq: *mut fqueue_t) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn fqueue_type(fq: *mut fqueue_t) -> fqtype;
}
extern "C" {
    pub fn fevent(
        set: *mut fset_t,
